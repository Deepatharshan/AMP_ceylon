          ...
          <div className="bg-white p-6 border border-[#ececec] rounded shadow-sm space-y-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input
                ...
                disabled={uploading}
                className="text-xs text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-[#f9f5f6] file:text-[#3a081a] hover:file:bg-gray-100 cursor-pointer"
              />
              <input type="hidden" name="image_url" value={imageUrl} />
              
              {uploading && (
                <p className="text-[10px] text-amber-600 font-medium animate-pulse">Uploading to Supabase Storage...</p>
              )}
              {uploadError && (
              ...
              {imageUrl ? (
                <div className="relative w-full h-full">
                  ...
                  <button
                    type="button"
                    onClick={() => setImageUrl('')}
                    className="absolute top-2 right-2 bg-white/80 hover:bg-white text-[#3a081a] p-1 rounded-full text-xs shadow-sm hover:scale-105 transition-transform"
                    title="Remove Image"
                  >
                    ✕
                  </button>
                ...
                <div className="text-center p-4">
                  ...
                  <p className="mt-1 text-xs text-gray-500">Image preview will show here once uploaded</p>
                </div>
              )}
            </div>
          </div>

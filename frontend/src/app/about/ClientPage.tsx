        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 max-w-4xl mx-auto">
            ...
            <motion.div variants={fadeUp} className="flex flex-col items-center text-center group">
              <div className="w-64 h-80 mb-8 overflow-hidden rounded-3xl border-[3px] border-[#8a385a]/20 shadow-lg relative bg-[#f4f4f4]">
                <Image 
            ...
            <motion.div variants={fadeUp} className="flex flex-col items-center text-center group">
              <div className="w-64 h-80 mb-8 overflow-hidden rounded-3xl border-[3px] border-[#8a385a]/20 shadow-lg relative bg-[#f4f4f4]">
                <Image 
                  ...
                  fill
                  sizes="256px"
                  className="object-cover object-[75%_10%] transition-transform duration-500 group-hover:scale-105"
                />
              </div>
